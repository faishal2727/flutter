...
/// @nodoc
@JsonSerializable()
class _$_Categories with DiagnosticableTreeMixin implements _Categories {
  const _$_Categories({required this.name});
...
abstract class _Categories implements Categories {
  const factory _Categories({required final String name}) = _$_Categories;
